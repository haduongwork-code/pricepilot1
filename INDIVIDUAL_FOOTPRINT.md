...
Code công thức tính lợi nhuận hiện tại để làm mốc so sánh với các kịch bản tăng giá.
Code công thức tính price elasticity từ dữ liệu giá bán và nhu cầu trong quá khứ.
Xử lý các khoảng min – max của biến thị trường để dữ liệu đưa vào mô phỏng không bị sai logic.
Chuẩn bị bộ dữ liệu đầu vào cuối cùng để chuyển sang phần M3 – Monte Carlo Simulation.
